 ...
 * submit.
 *
 * `framework` is a plain text input for now — the deploy-time
 * `SupportedFrameworks` service lands in a separate PR (#166);
 * once that merges the field can switch to `ChoiceType`.
 *
