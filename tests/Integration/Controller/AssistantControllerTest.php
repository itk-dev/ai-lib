 ...
 *
 * The detail page renders five tabs (Beskrivelse / Modelkort /
 * Readme / Viden / JSON) driven by the `?tab=` query parameter. The
 * tests below walk each one so the tab-partial include paths are
 * covered.
 */
